        ...
        <div className="h-screen bg-slate-200 pl-10 pt-10">
            ...
            <div className="max-w-96">
                <div className="input-area">
                    ...
                    <button className="bg-blue-500 text-white px-3 rounded-md font-bold ml-1 hover:bg-blue-900 focus:ring-2" onClick={handleInputBtn}>Add</button>
                </div>
                <ul className="mt-2">
                    {todo.map((item)=>{
                        return(
                            <li key="item" className="flex justify-between bg-blue-700 p-2 text-white rounded-lg mb-1">{item}<button onClick={()=>handleExitBtn(item)}>X</button></li>
                        );
                    })}
                </ul>
            </div>
